    ...
    animations: [
      {
        elements: {
          eb7Qye2GclS3: {
            transform: {
              data: { t: { x: -205.539505, y: -338.117493 } },
              keys: {
                o: [
                  {
                    t: 0,
                    v: { x: 205.539505, y: 338.117493, type: "corner" },
                    e: [0.42, 0, 0.58, 1],
                  },
                  {
                    t: 500,
                    v: { x: 184.403435, y: 316.980967, type: "corner" },
                    e: [0.445, 0.03, 0.35, 1.4],
                  },
                  {
                    t: 1800,
                    v: { x: 205.537567, y: 338.115088, type: "corner" },
                  },
                ],
              },
            },
          ...
          eb7Qye2GclS4: {
            transform: {
              data: { t: { x: -238.206497, y: -390.875992 } },
              keys: {
                o: [
                  {
                    t: 0,
                    v: { x: 238.206497, y: 390.875992, type: "corner" },
                    e: [0.42, 0, 0.58, 1],
                  },
                  {
                    t: 500,
                    v: { x: 238.206497, y: 412.012719, type: "corner" },
                    e: [0.445, 0.03, 0.35, 1.4],
                  },
                  {
                    t: 1800,
                    v: { x: 238.206497, y: 390.8786, type: "corner" },
                  },
                ],
              },
            },
          ...
          eb7Qye2GclS5: {
            transform: {
              data: { t: { x: -271.941002, y: -338.706497 } },
              keys: {
                o: [
                  {
                    t: 0,
                    v: { x: 271.941002, y: 338.706497, type: "corner" },
                    e: [0.42, 0, 0.58, 1],
                  },
                  {
                    t: 500,
                    v: { x: 293.076792, y: 317.569971, type: "corner" },
                    e: [0.445, 0.03, 0.35, 1.4],
                  },
                  {
                    t: 1800,
                    v: { x: 271.94266, y: 338.704092, type: "corner" },
                  },
                ],
              },
            },
        ...
        s: "",
      },
    ],
    options: "MODAxMEs4ODJmODA4MTUZlN2Y4MUgyZk40NzJKmNzk3YzZlNzEyZjhhR",
  },
  "__SVGATOR_PLAYER__",
  window
);
